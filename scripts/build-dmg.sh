...
xcodebuild -project "$PROJECT_DIR/diodiooodio.xcodeproj" \
    -scheme diodiooodio \
    -configuration Release \
    -archivePath "$BUILD_DIR/diodiooodio.xcarchive" \
    archive
...
# - Code signing
npx create-dmg "$BUILD_DIR/diodiooodio.app" "$BUILD_DIR" --overwrite
